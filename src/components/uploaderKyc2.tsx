...
export default function UploaderKyc2(
      ...
      onSubmit={async (e) => {
        ...
        fetch('/api/upload', {
          ...
          if (res.status === 200) {
            ...
            const result = await fetch("/api/user/updateKycImage2", {
              method: "POST",
              headers: {
                "Content-Type": "application/json",
              },
