                                        ...
                                        <div className='w-full flex flex-row items-center justify-between gap-2'>
                                            <div className='flex flex-col gap-2'>
                                                ...
                                                <div className='flex flex-row items-center justify-start gap-2'>
                                                    ...
                                                    <span className='text-lg text-red-500'>
                                                        {application?.affiliateInvitee?.data?.volMonth ? Number(application.affiliateInvitee.data.volMonth * 0.00005).toFixed(2) : 0}
                                                    </span>
                                        ...
                                        <div className='w-full flex flex-row items-center justify-between gap-2'>
                                            <div className='flex flex-col gap-2'>
                                                ...
                                                <div className='flex flex-row items-center justify-start gap-2'>
                                                    ...
                                                    <span className='text-lg text-red-500'>
                                                        {application?.affiliateInvitee?.data?.volMonth ? Number(application.affiliateInvitee.data.volMonth * 0.0000115).toFixed(2) : 0}
                                                    </span>
