...
export async function POST(request: NextRequest) {
  ...
  */
  ...
  const response = await alchemy.nft.getNftsForOwner(
    ...
    //contractAddresses: ["0x41FBA0bd9f4DC9a968a10aEBb792af6A09969F60"], // contractAddresses: [erc721ContractAddress],

    contractAddresses: [tokenContractAddressErc1155],
  });
