...
export async function POST(request: NextRequest) {
  ...
  const {
    ...
    //const path = `/copytrading/trader/total_profit_history`;

    const path = `/copytrading/trader/tpsl_open_orders`;
    ...
    try {
      ...
      /*
      {"code":200,"data":{"items":[]},"tid":"0e46f7373c6d433692c3f5a06c3027fc","success":true}
      */
