...
export async function POST(request: NextRequest) {
    ...
    */
    ...
    /* A pair of cute fluffy twin robots with round plush bodies, soft white fur, glossy black faces, and large glowing blue eyes. Each robot features black button decorations and short, chunky arms and legs, set against a yellow gradient background, creating a warm and peaceful atmosphere. */

    const englishPrompt = "A pair of cute fluffy twin robots with round plush bodies, soft white fur, glossy black faces, and large glowing blue eyes. Each robot features black button decorations and short, chunky arms and legs, set against a yellow gradient background, creating a warm and peaceful atmosphere.";
